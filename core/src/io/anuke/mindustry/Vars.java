...
public class Vars{
	...
	//texture pack file directory
	public static final FileHandle texturePackDirectory = gwt ? null : UCore.isAssets() ?
		Gdx.files.local("../../desktop/mindustry-texture-packs") : Gdx.files.local("mindustry-texture-packs/");
	//scale of the font
